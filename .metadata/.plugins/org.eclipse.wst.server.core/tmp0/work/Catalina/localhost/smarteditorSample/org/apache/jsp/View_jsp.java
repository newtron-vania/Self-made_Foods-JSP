 ...
 * Generated at: 2019-12-15 16:59:18 UTC
...
if( (String)session.getAttribute("userEmail") == null) 
 {
      ...
      out.write("\t\t\t\t\t\t\t<td>작성일</td>\t\r\n");
      out.write("\t\t\t\t\t\t\t<td colspan=\"2\">");
      out.print( bbs.getRecipeDate().substring(0, 11) + bbs.getRecipeDate().substring(11, 13) + "시"
							+ bbs.getRecipeDate().substring(14, 16) + "분");
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<a href=\"Update.jsp?recipeID=");
      out.print( recipeID );
      out.write("\" class=\"btn btn-primary\">수정</a>\r\n");
      out.write("\t\t\t\t\t\t<a href=\"DeleteAction.jsp?recipeID=");
      out.print( recipeID );
